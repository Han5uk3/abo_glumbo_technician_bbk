...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String get backgroundLocationPermissionRequired =>
      'ابو جلمبو ٹیکنیشن آپ کے مقام کا ڈیٹا جمع کرتا ہے، بشمول اس وقت جب ایپ بند ہو یا زیرِ استعمال نہ ہو، تاکہ آپ کی لائیو لوکیشن کسٹمر کے ساتھ شیئر کی جا سکے اور وہ آپ کی آمد اور کام کی پیش رفت کو ٹریک کر سکے۔ براہ کرم اپنے آلے کی ترتیبات میں لوکیشن کی اجازت \'ہر وقت اجازت دیں\' پر سیٹ کریں۔';

  @override
  String get locationDisclosureTitle => 'لوکیشن تک رسائی اور ڈیٹا کا استعمال';

  @override
  String get locationDisclosureTrackingMessage =>
      'ابو جلمبو ٹیکنیشن آپ کے مقام کا ڈیٹا جمع کرتا ہے، بشمول بیک گراؤنڈ میں جب ایپ بند ہو یا زیرِ استعمال نہ ہو۔\n\nیہ لوکیشن ڈیٹا ہمارے سرورز پر اپ لوڈ کیا جاتا ہے اور کسٹمر کے ساتھ شیئر کیا جاتا ہے تاکہ وہ فعال کام کے دوران آپ کی لائیو لوکیشن دیکھ سکے اور آپ کی آمد اور کام کی پیش رفت کو ٹریک کر سکے۔\n\nبیک گراؤنڈ میں ڈیٹا صرف اُس وقت جمع ہوتا ہے جب آپ کسی کام کو ٹریک کر رہے ہوں، اور ٹریکنگ بند کرنے پر رک جاتا ہے۔ آپ اپنے آلے کی ترتیبات میں کسی بھی وقت لوکیشن کی اجازت تبدیل کر سکتے ہیں۔';

  @override
  String get locationDisclosureJobOffersMessage =>
      'ابو جلمبو ٹیکنیشن آپ کے مقام کا ڈیٹا جمع کرتا ہے، بشمول بیک گراؤنڈ میں جب ایپ بند ہو یا زیرِ استعمال نہ ہو۔\n\nیہ لوکیشن ڈیٹا ہمارے سرورز پر اپ لوڈ کیا جاتا ہے اور آپ کو قریبی کام کی درخواستوں سے ملانے اور ہماری ٹیم کو آپ کا موجودہ سروس ایریا دکھانے کے لیے استعمال ہوتا ہے، بشمول آپ کے تقریبی شہر اور علاقے کے۔\n\nآپ اپنے آلے کی ترتیبات میں کسی بھی وقت لوکیشن کی اجازت تبدیل کر سکتے ہیں۔';

  @override
  String get locationAccessDeclined =>
      'اس کام کی ٹریکنگ شروع کرنے کے لیے لوکیشن کی اجازت ضروری ہے۔ آپ تیار ہونے پر اجازت دے سکتے ہیں۔';
  ...
  @override
  String get terms1title => 'لائسنس اور اہلیت';

  @override
  String get terms2title => 'سروس کا معیار اور ذمہ داری';

  @override
  String get terms3title => 'مناسب قیمت';

  @override
  String get terms4title => 'پلیٹ فارم کمیشن';

  @override
  String get terms5title => 'وارنٹی';

  @override
  String get terms6title => 'ذمہ داری کی قانونی حدود';
  ...
  @override
  String get terms1 =>
      'آپ اس بات کو یقینی بناتے ہیں کہ آپ کے پاس مشتہر کردہ خدمات فراہم کرنے کے لیے تمام ضروری پیشہ ورانہ لائسنس اور اہلیت موجود ہیں۔';

  @override
  String get terms2 =>
      'فراہم کردہ سروس کے معیار، استعمال کیے جانے والے آلات، اور کام کے دوران اور بعد میں جگہ کی حفاظت کو یقینی بنانے کے مکمل طور پر آپ ذمہ دار ہیں۔';

  @override
  String get terms3 =>
      'آپ معائنے کے بعد صارف کو پیشگی طور پر منصفانہ اور مناسب قیمت فراہم کرنے کے پابند ہیں۔';

  @override
  String get terms4 =>
      'آپ ایپ کو پہلے سے طے شدہ کمیشن ادا کرنے کے پابند ہیں، جو مکمل شدہ سروس کی قیمت سے منہا کیا جائے گا۔';
  ...
  @override
  String get terms6 =>
      'ایپ آپ کی جانب سے سروس کی فراہمی کے نتیجے میں ہونے والے کسی بھی مالی نقصان، املاک کو پہنچنے والے نقصان یا جسمانی چوٹ کی ذمہ دار نہیں ہے۔';

  @override
  String get terms5 =>
      'آپ \"وارنٹی پالیسی\" کے مطابق انجام دیے گئے کام پر وارنٹی فراہم کرنے کے پابند ہیں، اور وارنٹی کی مدت کے دوران آنے والی مرمت کے اخراجات آپ برداشت کریں گے۔';

  @override
  String get policy1 =>
      'پیشہ ورانہ لائسنس کی معلومات، قابلیت اور تجربہ، ذاتی/پیشہ ورانہ تصاویر، ادائیگیاں وصول کرنے کے لیے بینک اکاؤنٹ کی تفصیلات، اور ریٹنگ کی تاریخ۔';

  @override
  String get policy2 =>
      'آپ کی شناخت اور قابلیت کی تصدیق کرنے، آپ کی ادائیگیوں پر کارروائی کرنے، اور صارفین کو آپ کا پیشہ ورانہ پروفائل (ریٹنگز اور تجربہ) دکھانے کے لیے استعمال کیا جاتا ہے۔';

  @override
  String get policy3 =>
      'آپ کا نام، پیشہ ورانہ تصویر، اور ریٹنگز صارفین کے ساتھ شیئر کی جاتی ہیں۔ آپ کے بینک اکاؤنٹ کی معلومات شیئر نہیں کی جاتیں۔';
  ...
  String get bonusCalculationNote =>
      'آپ کا بونس مہینے میں ایک بار، ہر مہینے کی پہلی تاریخ کو ادا کیا جاتا ہے، صرف پچھلے مہینے کے دوران طے شدہ انسپیکشن فیس کی بنیاد پر۔ اسپیئر پارٹس، میٹیریلز اور دیگر چارجز بونس کے حساب میں شامل نہیں ہیں۔';
}

...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String get bonusCalculationNote =>
      'آپ کا بونس ہر گھنٹے بعد ادا کیا جاتا ہے، صرف اس گھنٹے کے دوران طے شدہ انسپیکشن فیس کی بنیاد پر۔ اسپیئر پارٹس، میٹیریلز اور دیگر چارجز بونس کے حساب میں شامل نہیں ہیں۔';
}
